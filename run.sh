...
declare models=("EU_RD_HA") 
# "MOS6" "MOS22" "FLR6" "FLR22" "RS3" "RS13" "PH4" "PH17" 
# "EU_MO" "EU_HA" "MO_HA" "PS_MO_HA" "EU_RD_HA" "EU_PS_MO_HA" "EU_MO_HA_RD"
...
declare models=("MOS6" "MOS22" "FLR6" "FLR22" "RS3" "RS13" "PH4" "PH17") # "MOS6" "MOS22" "FLR6" "FLR22" "RS3" "RS13" "PH4" "PH17"
for data_set in "${data_sets[@]}"; do 
    for model in "${models[@]}"; do 
        echo Data set=$data_set  Model=$model Method=$method
